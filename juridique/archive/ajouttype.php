            ...
            <div class="container background-white">
                <div class="row margin-vert-30">
                    ...
                    <div class="col-md-9">
                        <!-- Main Content -->
                        <div class="headline">
                            <h2 class="margin-bottom-20">Formulaire d'ajout type</h2>
                        </div>
                          
                        <form action="codeajouttype.php" method="POST">
                            <label>Type :</label>
                            ...
                            <tbody>
                            <?php $data = $db->query('select * from type'); 
                                foreach ($data as $donnee) {
                            ?>
                                <tr>
                                    <th><?php echo $donnee['id_type'] ?></th>
                                    <th><?php echo $donnee['type'] ?></th>
                                </tr>
                                <?php } ?>
                            </tbody>
