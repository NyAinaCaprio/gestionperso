...
connexiondb();
require_once('coderecherche.php')
            ...
            <div class="container background-white">
                <div class="row margin-vert-30">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-12">
<form action="editContenu.php" method="post" enctype="multipart/form-data" class=" ">
...
foreach ($req as $data) {
 ...
 ?>
  ...
  <div class="container ">
                 ...
                 <?php echo $data['projet'].' N°: '; echo $data['numero'].' du '; echo  $data
...
<p> Observation : <?php echo $data['observation'] ?></p>
      ...
      <p><a href="<?php echo $data['lien'] ?>">Redirection vers la page </a>  </p>
