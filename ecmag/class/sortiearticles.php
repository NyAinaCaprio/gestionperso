...
<body onLoad="demarragesortie()">
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         ...
         <input id="link-search-reset" value="Consultation sortie" onClick="consultationdetailsortie();" type="button">
        <input id="link-search-reset" value="Bon" onClick="affichelistesortiearticlesbon()" type="button">
